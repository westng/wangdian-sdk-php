...
$outerOutOrder->order_no = 'OO20201012012';
$outerOutOrder->warehouse_no = 'spw_warehouse';
// $transferInOrder->logisctics_code='';
$outerOutOrder->remark = 'api调整入库创建';

$outerOutOrderList = [];
$outerOutOrderDetail1 = new stdClass();
$outerOutOrderDetail1->spec_no = 'orange_new';
$outerOutOrderDetail1->num = 12;
$outerOutOrderDetail1->defect = 1;
$outerOutOrderDetail1->remark = 'api调整入库创建';

array_push($outerOutOrderList, $outerOutOrderDetail1);

$data = $client->call('wms.outer.OuterIn.createOrder', $outerOutOrder, $outerOutOrderList, true);
