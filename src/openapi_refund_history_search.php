...
$parMap = new stdClass();
$parMap->start_time = '2020-06-01 00:00:00';
$parMap->end_time = '2020-06-20 00:00:00';
$parMap->refund_no = 'TK2006040002';

$pager = new Pager(1, 0, true);

$response = $client->pageCall('aftersales.refund.Refund.searchHistory', $pager, $parMap);
