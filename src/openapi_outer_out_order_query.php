...
$parMap = new stdClass();
$parMap->start_time = '2020-10-01 00:00:00';
$parMap->end_time = '2020-10-20 00:00:00';
$parMap->warehouse_no = 'spw_warehouse';

$pager = new Pager(1, 0, true);

$response = $client->pageCall('wms.outer.OuterOut.queryWithDetail', $pager, $parMap);
