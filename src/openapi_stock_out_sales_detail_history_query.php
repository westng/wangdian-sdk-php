...
$parMap = new stdClass();
$parMap->start_time = '2020-03-01 00:00:00';
$parMap->end_time = '2020-03-15 00:00:00';

$pager = new Pager(1, 0, true);

$response = $client->pageCall('wms.stockout.Sales.queryHistoryWithDetail', $pager, $parMap);
